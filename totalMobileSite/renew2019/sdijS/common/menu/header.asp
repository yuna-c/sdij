...
ElseIf InStr(LCase(URL_SELF), "/jaejong") > 0 Then
    META_OG_URL         = "jaejong"
...
<head>
    ...
    <% Else %>
    <meta property="og:url" content="http://m.sdij.com/<%=META_OG_URL%>">
    ...
    <%If InStr(LCase(URL_SELF), "/on/default.asp") > 0 Or InStr(LCase(URL_SELF), "/on/default_0308.asp") > 0 OR InStr(LCase(URL_SELF), "/event/landing/default.asp") > 0 Or InStr(LCase(URL_SELF), "/academy/briefing/brief_landing") > 0 Or InStr(LCase(URL_SELF), "/academy/info/") > 0 Then %>
    ...
    <!--
    <link rel="icon" href="<%=URL_IMG%>/common/favicon.ico" type="image/x-icon">
    -->
