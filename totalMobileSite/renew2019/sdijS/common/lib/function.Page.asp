...
'	ifFunc	    : Function 여부
'==============================================================================================================
Sub makePagingFront( totalCount, lineSize, pageSize, curPage, linkPage, isFunc )
	Dim pageStart		' 시작 페이지
	Dim pageEnd			' 마지막 페이지
	Dim pageCount		' 총 페이지 수
	Dim endNum
    ...
    If totalCount > 0 Then
        ...
        pageHtml = ""
        pageHtml = pageHtml & "<div data-form='page'>"
...
'	ifFunc	    : Function 여부
'==============================================================================================================
Sub makePagingFront2019( totalCount, lineSize, pageSize, curPage, linkPage, isFunc )
	Dim pageStart		' 시작 페이지
	Dim pageEnd			' 마지막 페이지
	Dim pageCount		' 총 페이지 수
	Dim endNum
    ...
    If totalCount > 0 Then
        ...
        If curPage > 1 Then
            If isFunc Then
                pageHtml = pageHtml & "<a href='javascript:"& linkPage &"(1);'><span class='ico ico-page-prev2'>이전 10개 페이지</span></a>"
            Else
                pageHtml = pageHtml & "<a href='" &targetPage & "&page=1'><span class='ico ico-page-prev2'>이전 10개 페이지</span></a>"
            End If
        Else
            pageHtml = pageHtml & " "
        End If
        ...
        If isFunc Then
            If curPage = 1  Then
                pageHtml = pageHtml & ""
            Else
                pageHtml = pageHtml & "<a href='javascript:" & linkPage &"(" & curPage -1 & ");'><span class='ico ico-page-prev'>이전 페이지</span></a>"
            End If
        Else
