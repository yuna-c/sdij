    ...
    <div class="board-layout">
        ...
        <div class="board-table">
                ...
                <table class="prize-table">
                    ...
                    <tr>
                        <th>지원 대상</th>
                        <td style="word-break:break-all;">제한 없음 (학생 /교사 /저자 /컨텐츠 개발팀 등)</td>
                    </tr>
                    <tr>
                        <th>시상</th>
                        <td>
                            ...
                            <p class="mt10 txt-ind">※ 상금은 문항 채택 비용과 별도로 추가 지급되며, 시대인재에서 정한 일정 기준에 충족될 시 지급됩니다.</p>
                        </td>
                    </tr>
                    <tr>
                        <th>접수 기간</th>
                    ...
                    <tr>
                        <th>답변 기간</th>
                        <td>
                            <p class="lets">2019년 12월 1일 ~ 2019년 12월 15일</p>
                            <p class="mt10 txt-ind">※ 채택 여부 결정 시 인증한 휴대폰 번호로 문자가 발송</p>
                            <p class="mt10 txt-ind">※ 답변 기간 내에 개별 공지가 되지 않을 경우, <a class="deco" href="mailto:question@sdij.com">question@sdij.com</a>으로 문의해주시기 바랍니다.</p>
                        </td>
                    </tr>
                    <tr>
                        <th>접수 방법</th>
                        <td class="lets">지원서 다운로드 후 신청 페이지에 접수</td>
                    </tr>
                    <tr>
                        <th>유의 사항</th>
                        <td>
                ...
                <p class="mt20" style="word-break:break-all;">※ 문항 공모 관련 기타 질문 사항은 <a class="deco" href="mailto:question@sdij.com">question@sdij.com</a>으로 문의해주시기 바랍니다.</p>
            </div>
        <!--// E : board-view : 게시글 뷰 -->
                ...
                <div class="tab-content">
                    <ul class="list-number part">
                        ...
                        <li>
                            ...
                            <p>※ 등급변별문항이란, 정답률 60% 이하 수준의 문항을 말합니다. 과목마다 등급변별문항의 성격이 다르게 나타나는 점을 인지하고 있으므로, 각 과목마다의 특성을 적절히 고려하여 상금을 차등 지급할 예정입니다.</p>
                        </li>
                        <li>
                            <strong>우수 문항 채택 상금</strong>
                            <ol>
        ...
        <div class="txt-center mt40">
            <a href="javascript:IfFileDownload2('903032','form_sdij_content','sdij_question_raising.hwp');" class="btn btn-black btn-more-lg">접수양식 (HWP) 다운</a>
        </div>
    </div>
    <!--// E: 레이아웃 -->
</div>
...
<style>
.board-table table.prize-table tr th{ padding: 15px 10px ; border-right:1px solid #ededed; border-top:1px solid #ededed ; border-bottom:1px solid #ededed ; }
.board-table table.prize-table tr td{ text-align:left !important; padding-left:10px !important; border-bottom:1px solid #ededed; word-break: break-all; }
.prize-table tr a { display: inline !important; }
.board-table .table-tit{ margin-top:15px; }
.mt40{ margin-top:40px !important; }
.left-block{ width:30%; }
.deco{ border-bottom:1px solid #000; display: inline-block; }
.normal-ls li{ list-style:disc; margin-left: 20px;}
.txt-ind{ padding-left: 18px; text-indent: -18px;}
.lets{letter-spacing: -0.65px;}
/*가나다*/
...
<script src="/common/js/common_board.js"></script>
