...
<!--#include virtual="/totalMobileSite/renew2019/sdijS/common/include/incHeader.asp"-->
    ...
    <div class="layout-container fixed-container">
        <div class="content-layout">
            ...
            <!--// E : 구매내역 리스트 -->
            <p class="txt-guide mt10">*주문상품 변경은 <a href="/totalMobileSite/renew2019/sdijS/_pay/cart/cart.asp" class="txt-link color-blue">장바구니</a> 단계에서 가능합니다.</p>
...
<div class="dim-layer">
    ...
    <!-- S : 쿠폰 팝업 -->
    <!--#include virtual="/totalMobileSite/renew2019/sdijS/_pay/cart/coupon_pop.asp"-->
    <!--// E : 쿠폰 팝업 -->

    <!-- S : 배송비 쿠폰 팝업 -->
    <!--#include virtual="/totalMobileSite/renew2019/sdijS/_pay/cart/coupon_delivery_pop.asp"-->
    <!--// E : 배송비 쿠폰 팝업 -->

    <!-- S : 결제수단 팝업 -->
    <!--#include virtual="/totalMobileSite/renew2019/sdijS/_pay/cart/payment_pop.asp"-->
    <!--// E : 결제수단 팝업 -->
</div>
<!--// E : dim-layer -->
