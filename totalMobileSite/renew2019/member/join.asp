            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr class="info-txt">
                        ...
                        <td><input type="button" id="ipa" onclick="IfPhoneAuth()" value="인증번호 받기" class="btn btn-black"></td>
                    </tr>
                    <tr class="info-txt">
                        <th>&nbsp;</th>
                        <td colspan="3">
                            <span class="txt block">상품, 입시정보, 이벤트 정보 등을 SMS로 받음</span>
                            <label class="radio">
                                <input type="radio">
                                <span>받음</span>
                            </label>
                    ...
                    <tr class="info-txt">
                        <th>&nbsp;</th>
                        <td colspan="3">
                            <span class="txt block">상품, 입시정보, 이벤트 정보 등을 이메일로 받음</span>
                            <label class="radio">
                                <input type="radio">
                                <span>받음</span>
                            </label>
