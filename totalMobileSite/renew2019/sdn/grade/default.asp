...
<div class="layout-container">
    ...
    <div class="content-layout">
        ...
        <div class="board-tab">
                ...
                <!-- S : board-btn -->
                <div class="board-btn mb30 txt-center">
                    <a href="/renew2019/menber/login.asp" class="btn btn-sm btn-strong btn-black">로그인하기</a>
                    <a href="/renew2019/sdn/grade/students_hp_auth.asp" class="btn btn-sm btn-strong btn-black">재원생 인증하기</a>
                </div>
                <!--// E : board-btn -->

                <div class="txt-center mb30">
                    <!--인증이력 있는 회원의 경우-->
                    <select class="select select-short mb10">
                        <option value="재원생 선택">재원생 선택</option>
                        <option value="홍길동">홍길동</option>
                    </select>
                    <a href="/renew2019/menber/login.asp" class="btn btn-sm btn-strong btn-black ml10">확인</a>
                    <a href="/renew2019/sdn/grade/students_hp_auth.asp" class="block b txt-link">
                        여러 재원생을 둔 학부모라면 추가 인증을 할 수 있습니다.
                    </a>
                </div>
...
<script type="text/javascript">
    ...
    var onLeft = ($('#graph1 .score_bar > li.on').offset().left)-100;
    var scrolling =  $('#graph1').children('.scroll_box');
