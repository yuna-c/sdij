...
<div class="layout-container">
    ...
    <div class="content-layout">
        ...
        <div class="form-defult form-apply">
            <form action="" method="">
            <table>
                <colgroup>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                            <div class="set-input">
                            <input type="text" id="jjOnGrdImg" name="jjOnGrdImg" class="input-text" placeholder="jpg, bmp, png 이미지 파일만 업로드 가능" readonly="readonly" value="">
                            <div class="file">
                                  <a href="javascript:void(0);" class="file-btn" onclick="IfFileUpload('jjOnGrdImg', '', '', 'jaejong/exam_app', 'grade', 'image/*')">파일찾기</a>
                            </div>
                        </div>
                        </td>
                    </tr>
