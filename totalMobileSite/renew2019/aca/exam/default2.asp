...
<div class="layout-container exam-container">
	<div class="content-layout">
		...
		<div class="board-layout">
			...
			<!-- S : 응시 안내 -->
			<h4 class="table-tit">2021 시대인재 전국 모의고사 응시 안내</h4>
			<div class="white-box">
			...
			<div class="board-btn txt-center mt30">
				<!-- S : 응시 기간 버튼 -->
				<a href="javascript:IfMTestApp()" class="btn btn-lg2 btn-black">모의고사 응시하기</a>
				<a href="lecList2.asp" class="btn btn-md2">해설지 다운로드</a>
                <a href="cutView.asp" class="btn btn-md2">등급컷 확인하기</a>
				

				<!-- 개발 붙은 버전 건들지 말기 
				<a href="javascript:IfMTestApp()" class="btn btn-md2 btn-black">모의고사 응시하기</a>
                <a href="/aca/exam/lecList.asp" class="btn btn-md2 btn-black">해설지 다운로드</a>
                <a href="/aca/exam/cutView.asp" class="btn btn-lg2">등급컷 확인하기</a> 
				-->
                <!--
				<a href="lecList.asp" class="btn btn-md2">해설지 /해설강의 보기</a>
				<a href="#" class="btn btn-lg2">부엉이 포스트 확인하기</a>
				 <a href="/aca/son/2020/tail/my_std.asp" class="btn btn-md2">등급컷 확인하기</a>
                -->
			</div>
