...
<div class="layout-container">
    <div class="content-layout">
        ...
        <!-- S : 페이지 버튼 -->
        <div class="board-btn">
            <a href="javascript:void(0);" onclick="fnOpenLayer('dim3'); return false;" class="btn btn-mid btn-darkgray btn-strong">신청조회</a>
            <a href="javascript:void(0);" onclick="fnOpenLayer('dim4'); return false;" class="btn btn-mid btn-darkgray btn-strong">문자수신 DB등록</a>
        </div>
        <!--// E : 페이지 버튼 -->
        ...
        <div class="board-list">
            <ul>
                ...
                <li>
                    ...
                    <div class="data-tit">2018 자연계열 정시모집 입시결과 2018 자연계열 정시모집 입시결과</div>
                    <div class="data-txt">
