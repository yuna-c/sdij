	...
	<div class="content-layout">
		...
		<div class="board-layout">
			...
			<p class="txt-guide mb10">*안내 텍스트가 있을 경우 기재.</p>
     		...
     		<div class="form-toggle form-toggle2 mt10">
				...
				<label class="toggle-checkbox">
					<input type="checkbox" name="step1-subject" onclick="fnSubjectSel(this);" data-images="//placehold.it/200x280?text=2" data-subject="화학Ⅰ">
				...
				<label class="toggle-checkbox">
					<input type="checkbox" name="step1-subject" onclick="fnSubjectSel(this);" data-images="https://via.placeholder.com200x280?text=7" data-subject="지구과학Ⅱ">
