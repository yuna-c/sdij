<div class="modal-container modal-F modal-terms1">
    <div class="modal-header">
        <h3 class="tit-dep4">사이트 이용 약관</h3>
...
1장 총칙
제 1조 (목적)
이 약관은 리클래스 (이하 "회사"라 한다) 에서 운영하는 리클래스 (http://) (이하 “사이트”라 한다) 에서 제공하는 인터넷 관련 서비스(이하 "서비스"라 한다)를 이용함에 있어 "회사"와 이용자의 권리, 의무 및 책임 사항을 규정함을 목적으로 합니다.
제 2조 (효력 및 적용 등)
(1) 회사는 본 약관의 내용을 회원이 쉽게 알 수 있도록 회원 가입 절차 및 서비스 화면에 게시합니다.
(2) 본 약관의 내용은 리클래스 사이트 (http://)에 공지함으로써 효력이 발생합니다. 본 약관에 동의하고 회원 가입을 한 회원은 약관에 동의한 시점부터 동의한 약관의 적용을 받게 되고 약관이 개정된 경우에는 개정 약관의 효력이 발생한 시점부터 변경된 약관의 적용을 받습니다.
...
(1) ”사이트”란 회사가 재화 또는 용역(이하 “재화 등”이라 함)을 이용자에게 제공하기 위하여 컴퓨터 등 정보통신설비를 이용하여 재화 등을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 사이버몰을 운영하는 사업자의 의미로도 사용합니다.
(2) “회원’이라 함은 사이트에 접속하여 이 약관에 동의함으로써 회사와 서비스 이용계약을 체결하고 이용자 ID(이용자고유번호)와 Password(비밀번호)를 발급 받은 자를 말합니다.
(3) “이용자 ID”라 함은 회원 식별과 서비스 이용을 위하여 회원이 선정하고 회사가 승인하여 부여하는 문자와 숫자의 조합을 말합니다.
(4) “PASSWORD(비밀번호)”라 함은 서비스 이용 시 이용자 ID와 일치하는 이용자임을 확인하고, 회원의 개인정보 보호를 위하여, 회원 자신이 설정, 관리하는 문자와 숫자의 조합을 말합니다.
(5) “회원 정보”라 함은 이용자가 회사와 이용 계약 체결 시 회사에 등록하는 이용자 ID, 성명, 주소 등 이용자의 신상에 관련된 정보를 말합니다.
(6) “강좌 서비스”라 함은 사이트를 통해 제공되는 강좌 서비스를 말하며 그 이용 등에 관한 구체적인 사항은 본 약관 제14조에 기술된 바와 같습니다.
(7) “모의고사 판매 서비스”라 함은 사이트를 통해 회사가 제작 또는 유통하는 모의고사를 판매하는 서비스를 말하며, 그 이용 등에 관한 구체적인 사항은 본 약관 15조에 기술된 바와 같습니다.
(8) “도서 판매 서비스”라 함은 사이트를 통해 회사가 제작한 도서를 판매하는 서비스를 말하며 그 이용 등에 관한 구체적인 사항은 본 약관 제15조에 기술된 바와 같습니다.
2장 서비스 이용 계약
제 5조 (콘텐츠 등에 관한 정보제공 및 이용계약의 성립 등)
...
제 7조 (이용신청의 승낙 등)
(1) 회사는 회원이 제6조에서 정한 사항을 정확히 기재하고 본 약관에 동의할 경우 서비스의 이용 신청을 승낙합니다.
(2) 다음 각호의 경우에는 회원의 서비스 이용 신청의 승낙을 유보할 수 있습니다.
① 회사는 회원이 제6조에서 정한 사항을 정확히 기재하고 본 약관에 동의할 경우 서비스의 이용 신청을 승낙합니다.
...
(3) 본 조 제2항 각 호에 해당하는 게시물을 게재하여 회사로부터 경고를 받은 회원의 경우 사이트 서비스 이용에 제약이 있을 수 있습니다.
제 13조 (게시물의 저작권 등)
...
(4) 회원이 탈퇴를 하거나 제16조 제2항에 의하여 회원 자격을 상실한 경우에 본인 계정에 기록된 게시물은 삭제됩니다. 다만 공용 서비스 내에 기록된 게시물 등 다른 이용자의 정상적인 서비스 이용에 필요한 게시물은 삭제되지 않습니다.
...
제 15조 (모의고사 및 도서 판매 서비스 등)
(1) 회원은 회사가 제작 또는 유통하는 모의고사 및 도서를 구매할 수 있으며, 회사는 회원에게 판매하는 모의고사 및 도서 서비스를 제공할 수 있습니다.
(2) 회사는 회원이 구매 신청한 모의고사 및 도서를 품절 등의 사유로 회원에게 제공할 수 없을 경우에는 지체 없이 해당 사유를 회원에게 통지하고 환불 등의 필요한 조치를 취합니다.
(3) 회사는 회원이 모의고사 및 도서 구매 신청을 할 경우 배송 수단, 배송 비용 부담자, 배송기간 등을 신청 화면을 통하여 회원에게 제공합니다. 이와 관련하여 회사의 귀책사유로 인하여 배송 기간을 경과하여 이용자에게 손해가 발생한 경우 회사는 회원에게 발생한 손해 전부를 배상합니다.
(4) 회원은 모의고사 및 도서를 배송 받은 날부터 7일 이내에는 반품 또는 교환할 수 있습니다. 다만, 다음 각 호의 1에 해당하는 경우 모의고사 및 도서를 반품 또는 교환을 할 수 없습니다.
1. 이용자에게 책임 있는 사유로 모의고사 및 도서가 멸실 또는 훼손된 경우
2. 회원의 사용 또는 일부 소비에 의하여 모의고사 및 도서 가치가 현저히 감소한 경우
3. 시간의 경과에 의하여 재판매가 곤란할 정도로 모의고사 및 도서 등의 가치가 현저히 감소한 경우
4. 같은 성능을 지닌 모의고사 및 도서 등으로 복제가 가능한 경우 그 원본인 재화 등의 포장을 훼손한 경우
(5) 회사는 모의고사 및 도서 배송을 위하여 필요한 최소한의 이용자의 개인 정보(성명, 주소, 전화번호)를 배송업체에 제공할 수 있습니다. 다만 이 경우 회사는 제공 목적, 제공 업체명, 제공 항목 등 정보통신망 이용촉진 및 정보보호 등에 관한 법률 등 관련 법령에 따른 동의 절차를 이행하며, 회사는 이용자의 개인 정보에 대한 취급이나 보호 및 관리에 대한 사항을 배송업체와의 계약에 명시합니다.
제 16조 (불법사용 규제 관련)
...
3. 자신의 ID 및 강좌, 모의고사, 성적분석 등의 서비스를 타인이 이용하도록 하는 경우
4. 자신의 ID 및 강좌, 모의고사, 성적분석 서비스를 타인에게 판매, 대여, 양도하는 행위 및 이를 광고 하는 행위
5. 서비스 이용 중, 서비스를 복제하거나 복제를 시도하는 경우
...
2. 부정 이용자가 최초 경고를 받은 후 7일 이내 소명자료를 제출하지 않거나, 이미 소명 경험이 있는 이용자가 부정 이용자로 추가 적발된 경우 팝업 창, ID 일부 게시의 방법을 통하여 위반 내용이 통지되며, 사이트 이용 영구 차단 조치됩니다. 단, 자신의 ID 및 강좌, 모의고사 등의 서비스를 판매ㆍ양도하는 행위와 시도, 복제시도가 적발되었을 경우 법적 조치가 취해질 수 있습니다.
(3) 회원은 전항 제2호의 조치를 이유로, 서비스 이용기간의 연장을 요구할 수 없습니다.
(4) 회원은 회사로부터의 본조 제2항의 조치에 이의가 있는 경우, 회사 고객센터 또는 부정 사용관리센터에 해당사실에 대해 소명할 수 있으며, 그에 따라 이용에 관한 별도의 조치를 받을 수 있습니다. 이 경우 회원이 자신의 고의나 과실이 없었음을 입증한 경우 회사는 서비스 제공 정지기간만큼 이용기간을 연장합니다.
(5) 부정이용 식별방법 및 차단
...
4장 서비스 환불
제 17조 (청약철회)
(1) 도서 및 재화 등을 공급받은 날로부터 7일 이내에 전화 등으로 청약철회가 가능합니다. 다만, 재화 등의 내용이 회사가 표시·광고한 내용과 다르거나 계약내용과 다르게 이행된 경우에는 그 재화 등을 공급받은 날부터 3개월 이내, 그 사실을 안 날 또는 알 수 있었던 날부터 30일 이내에 청약철회가 가능합니다.
...
(3) 강좌서비스를 환불할 경우, 해당 강좌의 도서 및 재화가 포함되었을 경우 함께 반납하여야 합니다.
제 19조 (도서 출판 서비스 환불)
(1) 회사는 도서 출판 서비스의 경우 회원이 기결제한 수단을 통해 환불 처리합니다. 다만, 회사는 회원이 도서 반환을 완료한 이후 환불 처리를 하며 회원이 미성년자인 경우에는 환불 시 법정대리인의 동의를 거쳐 환불을 합니다.
(2) 회사는 회원의 단순 변심으로 인하여 도서를 반품하거나 교환을 요청하는 경우에는 회원이 도서의 반환 등에 필요한 비용을 부담합니다. 다만 회사에 귀책 사유가 있는 경우에는 회사가 비용 전부를 부담합니다.
제 20조 (과오금의 환급)
(1) 회원이 대금을 결제함에 있어서 과오금을 지급한 경우 회사는 대금결제와 동일한 방법으로 과오금을 환불합니다. 다만, 동일한 방법으로 과오금의 환불이 불가능할 때에는 즉시 이를 고지하고, 회원이 선택한 방법으로 환불합니다.
...
(4) 회사는 회원의 개인정보를 본인의 동의 없이 제3자에게 유출하거나 누설하지 않습니다. 다만, 적법한 절차를 거친 국가기관의 요구나 수사상 또는 기타 공익을 위하여 필요하다고 인정되는 경우는 예외로 합니다. 회사는 관련법령이 정하는 바에 따라서 회원 등록 정보를 포함한 회원의 개인정보를 보호하기 위하여 노력하며 회원의 개인정보보호에 관해서는 관련 법령 및 회사가 정하는 "개인정보취급방침/청소년보호정책"에 정한 바에 의합니다.
...
(3) 회원은 서비스의 이용을 위해 본인의 개인 정보를 직접 관리하여야 하며 제6조의 등록 사항에 변경이 있을 경우 회사가 제공하는 서비스 내의 개인정보 수정 페이지를 통하여 변경 사항을 즉시 수정하여야 합니다.
6장 계약해지 및 이용제한
제 23조 (계약해지 및 이용제한)
(1) 회원은 회사가 제공하는 서비스 내의 회원 탈퇴 기능, 전화 등을 통하여 언제라도 서비스 탈퇴를 요청할 수 있습니다. 이 경우 회사는 제10조 제2항 각호와 같은 불가피한 사정이 없는 한 회원의 탈퇴 요청을 지체 없이 처리합니다.
(2) 회사는 회원이 관련 법령 또는 본 약관이 금지하거나 공서양속에 반하는 행위를 하는 경우, 당해 회원에게 해당 사실을 통지한 후, 서비스 이용 권한을 일정 기간 제한하거나 이용 권한을 박탈할 수 있습니다. 다만, 회사는 회원에게 시정 또는 소명 기회를 부여합니다. 회원의 이의신청이 정당한 경우 회사는 즉시 회원이 서비스를 이용할 수 있도록 필요한 조취를 취하고 정지한 기간만큼 이용기간을 연장합니다.
제 24조 (양도 금지 등)
...
제 28조 (재판관할)
(1) 회사와 회원 간의 서비스 이용계약에 관한 소송은 제소 당시의 회원의 주소에 의하고, 주소가 없는 경우 거소를 관할하는 지방법원의 전속관할로 합니다.
(2) 제소 당시 회원의 주소 또는 거소가 분명하지 아니한 경우에 회사와 회원 간의 서비스 이용계약에 관한 소송에 과한 관할법원은 민사소송법에 따라 정합니다.
이 약관은 2020년 01월 03일부터 시행됩니다.
        </textarea>
    </div>

    <div class="modal-btn">
        <a href="javascript:void(0);" onclick="fnCloseModal('.modal-terms1');" class="btn btn-gray">취소</a>
        <input type="button" onclick="fnTermsModal('#agree1'); fnCloseModal('.modal-terms1');" class="btn btn-black" value="동의하기">
    </div>
</div>