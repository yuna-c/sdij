            ...
            <div class="tab-content tab-on">
                ...
                <div class="grade-box">
                    ...
                    <h3>
                        ...
                        <span>14회</span> 수능 모의평가 성적분석
                    </h3>
                    <ul>
                        <li>점수<strong>92점</strong></li>
                        <li>등급<strong>1</strong></li>
                ...
                <div class="board-table">
                    ...
                    <table>
                        ...
                        <tr>
                            <th rowspan="4" class="txt-left">미적분2</th>
                            <th class="txt-left">지수함수와<br/> 로그함수</th>
                            <td>96</td>
                            <td class="color-red">96</td>
                            <td>96</td>
                            <td>94.5</td>
                        ...
                        <tr>
                            <th class="txt-left">공간벡터와 <br/>공간도형의<br/>방정식</th>
                            <td>127</td>
...
<script type="text/javascript">
    ...
    var onLeft = ($('#graph2 .score_bar > li.on').offset().left)-417;
    var scrolling =  $('#graph2').parent('.scroll_box');
