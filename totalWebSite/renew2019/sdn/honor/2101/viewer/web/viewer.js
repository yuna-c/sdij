...
var PDFViewerApplication = {
  ...
  setInitialView: function setInitialView(storedHash) {
    ...
    var elHeight = viewerEl.clientHeight;
    console.log(elHeight);

    document.getElementById("viewerHtml").style.height = elHeight + 'px';
    document.getElementById("mainContainer").style.height = elHeight + 'px' + 30;
    console.log(window.parent.document.getElementById('pdfviewer'));

    window.parent.document.getElementById('pdfviewer').height = elHeight + 30 + 'px';
  },
...
var validateFileURL;
{
  var HOSTED_VIEWER_ORIGINS = ['null', 'http://mozilla.github.io', 'https://mozilla.github.io', 'http://dfile.sdij.com', 'https://dfile.sdij.com', 'http://dev.sdij.com', 'https://dev.sdij.com', 'http://dm.sdij.com', 'https://dm.sdij.com', 'http://www.sdij.com', 'https://www.sdij.com', 'http://m.sdij.com', 'https://m.sdij.com'];
