...
<div class="layout-container">
	...
	<div class="board-layout relative">
		...
		<div class="quick-banner">
			...
			<a href="review_list.asp" class="active">2020학년도 3기</a>
		...
		<div class="board-tab">
			<div class="tab-list mb20">
				<a href="javascript:void(0);" onclick="location.href='video_list.asp'">영상인터뷰</a>
				<a href="javascript:void(0);" class="selected" onclick="location.href='review_list.asp'">학습수기</a>
			</div>
		...
		<!-- S : 리스트 -->
		<div class="honor-list review-list">
			<ul>
				<li>
					<a href="review_view.asp">
						<div class="data-name">정연재 학생</div>
						<div class="data-content">국/수/탐/탐 전과목 만점자 <br>(영어 1등급 /한국사 1등급)</div>
					</a>
				</li>
				...
				<li>
					<a href="review_view.asp">
						...
						<div class="data-content">국/수/탐/탐 전과목 만점자<br> (영어 1등급 /한국사 2등급)</div>
					</a>
				</li>
				...
				<li>
					<a href="review_view.asp">
						...
						<div class="data-content">자연계 백분위 전국수석 <br> (국/수/탐/탐 백분위점수 합 400)</div>
					</a>
				</li>
				...
				<li>
					<a href="review_view.asp">
						...
						<div class="data-content">자연계 표준점수 전국수석<br> (국/수/탐/탐 표준점수 총합 413)</div>
					</a>
				</li>
