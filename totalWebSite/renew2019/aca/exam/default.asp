...
<!-- S : container -->
<div class="layout-container index-container">
	...
	<div class="board-layout">
		<h2 class="page-tit mt0">
			2021 시대인재 전국 온라인 모의고사
			<small>
		...
		<div class="board-btn txt-center mt30">
			<!-- S : 응시 기간 버튼 -->
			<a href="detail.asp" class="btn btn-lg2 btn-black">모의고사 응시하기</a>

			<!-- S : 응시 종료 후 버튼 -->
			<a href="detail.asp" class="btn btn-lg2 btn-black">내 답안 확인하기</a>
			<a href="lecList.asp" class="btn btn-lg2">해설지 /해설강의 보기</a>
