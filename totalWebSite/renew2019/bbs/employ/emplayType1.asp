            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <% else %>
                        <td><input type="button" onclick="window.open('../common/include/incDim6.asp', '학교검색', 'width=480, height=550, location=no, status=no, scrollbars=no');" value="학교검색" class="btn btn-black"></td>
                        <% end if %>
                    </tr>
                    <tr>
                        <th>계열/학년</th>
