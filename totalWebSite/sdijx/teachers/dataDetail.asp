<%
'-----------------------------------------------------------------------
' 업 무 명 : 시대인재 Digital > 선생님 게시판 > 학습자료실 글보기
' 모듈기능 : 시대인재 Digital > 선생님 게시판 > 학습자료실 글보기
' 파 일 명 : dataDetail.asp
' 작성일자 : 
' 작 성 자 : 
'-----------------------------------------------------------------------
' 변경일자   변경자  변동내역
...
<!--#include virtual="/totalWebSite/sdijx/common/include/incHeader.asp"-->
    ...
    <section id="container" class="board-container">
        ...
        <div class="wide-layout float-area mt40">
            <!-- S : lnb -->
            <!--#include file="incLnb.asp"-->
            <!--// E : lnb -->

            <div class="lnb-layout absolute fr">
                <h2 class="tit-dep1">
                    <span class="tit">
                        학습 자료실
                        <em class="sub">346</em>
                ...
                <div class="view-pager">
                    ...
                    <div class="right">
                        <a href="javascript:void(0);" class="btn-ico"><i class="ico-left"></i> 이전</a>
                        <a href="javascript:void(0);" class="btn-ico">다음 <i class="ico-right"></i></a>
                    </div>
                </div>
            </div>
        </div>        
